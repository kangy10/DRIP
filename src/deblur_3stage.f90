...
! noisy and blurred data using the method proposed in the    !
! paper                                                      !
...
subroutine deblur_3stage(n, obsImg, bandwidth, edge1, edge2, &
  estImg)
  ...
  do i = k, n + k
     do j = k, n + k
        ...
        ! estimator. Otherwise, we do deblurring.
                    ...
                    do i1 = i - k, i + k
                       do j1 = j - k, j + k
                          ...
                          if ((ttemp <= ra) .AND. (temp22 >= 0D0)) then 
                             ...
                             ttemp2 = abs(temp22)/sqrt(sigmaxy**2 + &
                                  lambda1**2)
                    ...
                    do i1 = i - k, i + k
                       do j1 = j - k, j + k
                          ...
                          if ((ttemp <= ra) .AND. (temp22 >= 0D0)) then 
                             ...
                             ttemp2 = abs(temp22)/dsqrt(sigmaxy**2 + &
                                  lambda1**2)
                             aa = ker(dble(i1 - i)/dble(k), &
                                  dble(j1 - j)/dble(k)) * &
                                  ker1(ttemp2/ttemp1)
