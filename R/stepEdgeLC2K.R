# This is R source code for function 'stepEdgeLC2K', in the R
# package "image".
# Date: April 29, 2013
# Creator: Yicheng Kang

stepEdgeLC2K <- function(image, bandwidth, thresh, plot =
                           FALSE){
  if (!is.matrix(image))
...
# of the image is too high.")
  ...
  u <- as.double(thresh)
  out <- .Fortran(C_lc2k_diff, n = as.integer(n1 - 1), obsImg = z,
